...
export const membershipPageSchema = defineType({
  ...
  fields: [
      ...
      of: [
        {
          ...
          fields: [
            ...
            },
            {
              ...
              title: 'Give ID',
              type: 'string',
              description: "Givecloud form ID used to open this tier's donation flow.",
            },
            {
              name: 'buttonLabel',
              title: 'Button Label',
              ...
              description: 'What the donation button will say',
            },
          ],
          preview: {
            select: {
    ...
    },
    {
      ...
      fields: [
        ...
        },
        {
          ...
          type: 'array',
          of: [{ type: 'block' }],
          description: 'Optional text shown beneath the thermometer and progress totals.',
        },
      ],
    ...
    },
    {
      ...
      description: 'Heading shown alongside the FAQ section near the bottom of the page.',
    },
    {
      ...
      type: 'array',
      of: [{ type: 'block' }],
      description: 'Supporting copy shown beneath the support section heading.',
    },
    {
      name: 'faqItems',
      title: 'FAQ Items',
