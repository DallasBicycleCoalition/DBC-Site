...
export type SocialRidesPage = {
  _id: string;
  _type: 'socialRidesPage';
  _createdAt: string;
  _updatedAt: string;
  _rev: string;
  title?: string;
...
// Source: src/pages/go/[slug].ts
// Variable: shortLinkQuery
// Query: *[_type == "shortLink" && slug.current == $slug][0]{ destination }
export type ShortLinkQueryResult = {
